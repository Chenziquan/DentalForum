...
public class PutObjectSamples {
    ...
    public PutObjectSamples(String uploadFilePath, UploadPictureCallBack callBack) {
        this.oss = OssServer.getInstance().getOss();
        this.testBucket = "dentalforum";
        this.testObject = "dentalforum";

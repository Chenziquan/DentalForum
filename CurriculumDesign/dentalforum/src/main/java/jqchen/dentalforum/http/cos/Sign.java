...
import jqchen.dentalforum.http.cos.common_utils.CommonCodecUtils;
import jqchen.dentalforum.http.cos.common_utils.CommonPathUtils;
...
public class Sign {
    ...
    public static String getSign(String cosPath) throws AbstractCosException {
        Credentials credentials = new Credentials(Constants.COS_APPID, Constants.COS_SECRETID, Constants.COS_SECRETKEY);
        return getPeriodEffectiveSign(Constants.COS_BUCKETNAME, cosPath, credentials, System.currentTimeMillis() / 1000 + 60 * 60 * 24);
    }
